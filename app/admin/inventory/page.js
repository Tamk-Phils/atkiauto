  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch('/api/admin/delete', {
        ...
        body: JSON.stringify({ table: 'cars', id })
      })
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4 sm:gap-6 min-w-0">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto overflow-hidden">
          ...
          <button onClick={openAdd}
            className="flex-none inline-flex items-center justify-center gap-1 bg-primary text-white rounded-lg font-black uppercase tracking-widest hover:scale-[1.02] active:scale-95 transition-all whitespace-nowrap p-2 text-[10px]"
          >
            <Plus size={16} />
        ...
        {showForm && (
          <div className="fixed inset-0 z-[200] flex items-center justify-center">
            ...
            <motion.div initial={{ scale: 0.95, y: 20 }} animate={{ scale: 1, y: 0 }} exit={{ scale: 0.95, y: 20 }}
              className="bg-white lg:rounded-3xl p-6 lg:p-10 w-full max-w-[800px] h-full sm:h-auto sm:max-h-[90vh] overflow-y-auto shadow-2xl relative z-10 text-left">
              <div className="flex items-center justify-between mb-8">
                <div>
                  ...
                  <p className="text-slate-500 text-xs font-medium">Fill in the details below to update inventory.</p>
                </div>
          ...
          <table className="border-collapse table-fixed" style={{ width: '1200px', minWidth: '1200px' }}>
            <thead>
              <tr className="bg-slate-50/50">
                ...
                <th className="w-[150px] px-6 py-4 text-[10px] font-black uppercase tracking-widest text-slate-400 text-left border-b border-slate-100">Price / Fees</th>
                  ...
                  {filtered.map(car => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-[10px] font-black text-slate-500 uppercase tracking-widest leading-relaxed text-left">
      ...
      <AnimatePresence>
        {toast && (
          <motion.div 
            ...
            <div className="flex-1 leading-tight uppercase tracking-tight italic text-left">{toast.msg}</div>
