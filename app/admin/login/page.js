    ...
    <div className="min-h-screen flex items-center justify-center bg-[radial-gradient(ellipse_80%_60%_at_40%_30%,#161620_0%,#0a0a0b_100%)] p-6 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-10 text-white">
          ...
          <h1 className="text-2xl font-black tracking-tight flex items-center justify-center gap-2 uppercase italic">
        ...
        <div className="text-center mt-10">
          ...
          <Link href="/" className="text-white/40 hover:text-white transition-all text-xs font-black uppercase tracking-widest no-underline">
            ← Back to Site
          </Link>
        </div>
      </motion.div>
