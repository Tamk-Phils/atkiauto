...
class EmailService {
  ...
  async sendEmail({ type, name, email, phone, car_name, income, message, details }) {
    try {
        ...
        const recipient = process.env.NEXT_PUBLIC_ADMIN_EMAIL || 'support@attkissonautos.com';
        console.log(`[EmailService] Sending alert to: ${recipient}`);
        ...
        console.log(`[EmailService] Alert successfully sent! MessageId: ${info.messageId}`);
