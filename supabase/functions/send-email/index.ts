...
serve(async (req) => {
  ...
  try {
    ...
    // SMTP Configuration from ENV (Using Attkisson Autos Support Email)
    ...
    // Premium HTML Template (Attkisson Autos Branding: Red/Black/White)
    const htmlBody = `
      <!DOCTYPE html>
      <html>
        <head>
        ...
        <body>
          <div class="container">
            ...
            <div class="footer">
              This email was generated by the Attkisson Autos Portal.
            </div>
          </div>
        </body>
      </html>
    ...
    await client.send({
      from: username,
      to: username, // Send to self (support@attkissonautos.com)
      subject: subject,
      content: htmlBody,
      html: htmlBody
    });
